...
public final class Class_19e implements SomeLevelDataVariablesInterface {
   ...
   public static void sub_6f() {
      var_6ce = false;
      int var0 = Class_b3.var_1d - 2 - 2 - 2;
      var_257 = Class_b3.var_b0 - 3 - 3 - (var_7ed == 22 ? 0 : var_d0 - 5);
   ...
   private static void sub_151() {
      var_12e = Class_b3.var_1d - var_1bd >> 1;
      var_18c = Class_b3.var_b0 - (var_7ed == 22 ? 0 : var_d0 - 5) - var_1cf >> 1;
      var_285 = var_12e + 2 + 5;
   ...
   public static void sub_29c(Graphics var0) {
      for(int var1 = 0; var1 < Class_b3.var_12a + 2; ++var1) {
         for(int var2 = 0; var2 < Class_b3.var_18b + 2; ++var2) {
